...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(err);
            setError(err.response?.data?.message || 'بيانات الدخول غير صحيحة. حاول مرة أخرى.');
        } finally {
            setLoading(false);
        }
    };
                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-gray-100">
                        <div className="p-8 sm:p-12">
                            ...
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-black text-gray-900 mb-4">تسجيل الدخول</h2>
                                <p className="text-[#00A8E8] font-bold text-lg mb-2">أهلاً بك من جديد في أم النور</p>
                            ...
                            <p className="text-gray-400 text-[10px] sm:text-xs text-center mt-6 font-medium leading-relaxed">
                                بدخولك، أنت توافق على <a href="#" className="underline hover:text-gray-600 transition-colors">الشروط والأحكام</a> و <a href="#" className="underline hover:text-gray-600 transition-colors">سياسة الخصوصية</a>
                            </p>
                        </div>
                        ...
                        <div className="bg-[#f8fcff] py-6 text-center border-t border-gray-50">
                            <p className="text-gray-500 text-sm font-bold">
                                ليس لديك حساب؟ <Link to="/signup" className="text-[#00A8E8] hover:underline transition-all">أنشئ حساباً جديداً</Link>
                            </p>
                        </div>
                    </div>
                </div>
